...
export default function EthereumAssetScreen({navigation,route}){
            ...
            <View style={styles.controlContainer}>
                <View style={styles.control}>
                    <CommonTouchableOpacity style={styles.element} onPress={()=> {
                        navigation.navigate("EthereumAssetSendScreen");
                    }}>
                    ...
                    <CommonTouchableOpacity style={styles.element} onPress={()=> {
                        navigation.navigate("EthereumAssetReceiveScreen");
                    }}>
                        <View style={styles.elementIcon}>
                            <ArrowDown/>
                        </View>
                    ...
                    <CommonTouchableOpacity style={styles.element} onPress={()=> {
                        navigation.navigate("EthereumAssetTransactionScreen");
                    }}>
                        <View style={styles.elementIcon}>
                            <Time/>
                        </View>
