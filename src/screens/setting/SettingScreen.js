  ...
  return (
    <Root>
      <SafeAreaView style={[styles.container, {backgroundColor: theme.backgroundColor1}]}>
        <CommonHeader onPressBack={() => navigation.goBack()} title={lang.setting} />

        <View style={styles.contentContainer}>
          <CommonTouchableOpacity style={styles.item} onPress={() => navigation.navigate('WalletListScreen')}>
            ...
            <View style={{flex: 1, paddingLeft: 10, justifyContent: 'center'}}>
              <CommonText style={{fontSize: 14}}>{activeMulticoinWallet.name}</CommonText>
              {/* <CommonText style={{fontSize: 12}}>{activeMulticoinWallet.address}</CommonText> */}
            </View>
