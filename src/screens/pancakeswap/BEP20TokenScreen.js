...
export default function BEP20TokenScreen({navigation,route}){
    ...
    useEffect(()=>{
        dispatch(TokenAction.getTokens(applicationProperties.networks[2].chainId));
    },[])
        ...
        <Root>
            <SafeAreaView style={[styles.container,{backgroundColor : theme.backgroundColor1}]}>
                <View style={[styles.header,{backgroundColor: theme.mainColor}]}>
                    ...
                    <CommonText style={styles.title}>{lang.bep20Tokens}</CommonText>
                    <View style={{width : 40}}>
