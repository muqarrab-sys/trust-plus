...
export default function EthereumReceiveScreen({navigation,route}){
            ...
            <SafeAreaView style={[styles.container,{backgroundColor : theme.backgroundColor1}]}>
                ...
                <View style={styles.contentContainer}>
                    ...
                    <View style={styles.description}>
                        <CommonText style={styles.text}>{lang.sendOnly} {activeWallet.network.symbol} {lang.toThisAddress}</CommonText>
