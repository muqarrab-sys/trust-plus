...
export default function SmartChainExportScreen({navigation,route}){
                ...
                <View style={styles.contentContainer}>
                    <View style={styles.qrCode}>
                        ...
                        <View style={styles.qrCodeFooter}>
                            <CommonText style={styles.text}>{item.privateKey}</CommonText>
                        </View>

                    </View>
                    <View style={styles.controls}>
                        <CommonTouchableOpacity style={styles.element} onPress={async () => {
                            await copyToClipboard(item.privateKey);
                        }}>
